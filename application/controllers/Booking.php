...
public function exportToPdf()
    {
        ...
        if ($data1<1){
            $this->session->set_flashdata('pesan','<div class="alert alert-messege alert-danger" role="alert">Tidak Ada Data Booking, Silahkan Lakukan Booking Terlebih Dahulu</div>');
            redirect(base_url());
